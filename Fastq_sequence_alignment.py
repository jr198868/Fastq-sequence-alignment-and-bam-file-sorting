...
#2. Using BWA mem algorithm to process the alignment
os.chdir('/home/rjing/Desktop/bwa-master')
...
#3. Using samtools to convert sam file to a bam file
...
#4. Using samtools to sort the bam file
...
#5. Using samtools to create index for the sorted bam files
